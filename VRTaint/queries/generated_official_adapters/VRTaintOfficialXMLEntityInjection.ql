/**
 * @name VRTaint lifecycle extension for official XMLEntityInjection flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-xmlentityinjection
...
select sink.getNode(), source, sink,
  "Official XMLEntityInjection source reaches its official sink through Unity semantic propagation."
