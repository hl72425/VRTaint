/**
 * @name VRTaint lifecycle extension for official CommandInjection flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-commandinjection
...
select sink.getNode(), source, sink,
  "Official CommandInjection source reaches its official sink through Unity semantic propagation."
