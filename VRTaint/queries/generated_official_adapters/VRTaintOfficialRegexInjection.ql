/**
 * @name VRTaint lifecycle extension for official RegexInjection flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-regexinjection
...
select sink.getNode(), source, sink,
  "Official RegexInjection source reaches its official sink through Unity semantic propagation."
