/**
 * @name VRTaint lifecycle extension for official SqlInjection flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-sqlinjection
...
select sink.getNode(), source, sink,
  "Official SqlInjection source reaches its official sink through Unity semantic propagation."
