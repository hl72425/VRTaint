/**
 * @name VRTaint lifecycle extension for official LogForging flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-logforging
...
select sink.getNode(), source, sink,
  "Official LogForging source reaches its official sink through Unity semantic propagation."
