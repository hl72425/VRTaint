/**
 * @name VRTaint lifecycle extension for official HardcodedCredentials flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-hardcodedcredentials
...
select sink.getNode(), source, sink,
  "Official HardcodedCredentials source reaches its official sink through Unity semantic propagation."
