/**
 * @name VRTaint lifecycle extension for official ExposureOfPrivateInformation flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-exposureofprivateinformation
...
select sink.getNode(), source, sink,
  "Official ExposureOfPrivateInformation source reaches its official sink through Unity semantic propagation."
