/**
 * @name VRTaint lifecycle extension for official XPathInjection flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-xpathinjection
...
select sink.getNode(), source, sink,
  "Official XPathInjection source reaches its official sink through Unity semantic propagation."
