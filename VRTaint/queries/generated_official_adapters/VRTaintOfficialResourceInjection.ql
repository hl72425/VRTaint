/**
 * @name VRTaint lifecycle extension for official ResourceInjection flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-resourceinjection
...
select sink.getNode(), source, sink,
  "Official ResourceInjection source reaches its official sink through Unity semantic propagation."
