/**
 * @name VRTaint lifecycle extension for official ConditionalBypass flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-conditionalbypass
...
select sink.getNode(), source, sink,
  "Official ConditionalBypass source reaches its official sink through Unity semantic propagation."
