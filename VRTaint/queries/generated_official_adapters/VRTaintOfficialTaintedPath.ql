/**
 * @name VRTaint lifecycle extension for official TaintedPath flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-taintedpath
...
select sink.getNode(), source, sink,
  "Official TaintedPath source reaches its official sink through Unity semantic propagation."
