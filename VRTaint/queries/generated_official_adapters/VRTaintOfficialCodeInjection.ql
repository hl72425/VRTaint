/**
 * @name VRTaint lifecycle extension for official CodeInjection flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-codeinjection
...
select sink.getNode(), source, sink,
  "Official CodeInjection source reaches its official sink through Unity semantic propagation."
