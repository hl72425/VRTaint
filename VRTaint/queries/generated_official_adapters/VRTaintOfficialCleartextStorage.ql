/**
 * @name VRTaint lifecycle extension for official CleartextStorage flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-cleartextstorage
...
select sink.getNode(), source, sink,
  "Official CleartextStorage source reaches its official sink through Unity semantic propagation."
