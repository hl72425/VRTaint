/**
 * @name VRTaint lifecycle extension for official UnsafeDeserialization flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-unsafedeserialization
...
select sink.getNode(), source, sink,
  "Official UnsafeDeserialization source reaches its official sink through Unity semantic propagation."
