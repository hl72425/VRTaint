/**
 * @name VRTaint lifecycle extension for official LDAPInjection flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-ldapinjection
...
select sink.getNode(), source, sink,
  "Official LDAPInjection source reaches its official sink through Unity semantic propagation."
