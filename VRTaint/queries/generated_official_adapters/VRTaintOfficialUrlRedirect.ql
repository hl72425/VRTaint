/**
 * @name VRTaint lifecycle extension for official UrlRedirect flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-urlredirect
...
select sink.getNode(), source, sink,
  "Official UrlRedirect source reaches its official sink through Unity semantic propagation."
