/**
 * @name VRTaint lifecycle extension for official MissingXMLValidation flow model
 ...
 * @kind path-problem
 * @id cs/vrtaint-official-missingxmlvalidation
...
select sink.getNode(), source, sink,
  "Official MissingXMLValidation source reaches its official sink through Unity semantic propagation."
